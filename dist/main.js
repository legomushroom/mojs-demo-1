...
/***/ function(module, exports, __webpack_require__) {
	...
	Main = (function() {
	  ...
	  Main.prototype.createBall_2 = function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	FirstBall = (function() {
	  ...
	  FirstBall.prototype.create = function() {
	    var ball, ballStart, burst1, burst2, circle, gooDur, mp, radiusDeltaX, radiusDeltaY, retrunValue, trail1, trail2, trail3, yDelta;
	    radiusDeltaX = {};
	    radiusDeltaY = {};
	    ...
	    return retrunValue = {
	      tweens: [burst1.tween, burst2.tween, mp.tween, ball.tween, circle.tween, trail1.tween, trail2.tween],
	      ball: ball
	    };
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	FirstBall = (function() {
	  ...
	  FirstBall.prototype.create = function() {
	    var burst, it, mp, oDelay, oDuration, oEasing, oLineStagger, oStagger, opacityDelta, trail, trailFade, translate, tween;
...
/***/ function(module, exports, __webpack_require__) {
	...
	FirstBall = (function() {
	  ...
	  FirstBall.prototype.create = function() {
	    var burst, burst2, it, mp, oDelay, oDuration, oEasing, oLine1Stagger, oLine2Stagger, oStagger, opacityDelta, trail, trailFade, translate;
	    trail = new mojs.Transit({
	      bit: this.pathMask,
	      fill: 'transparent',
	      strokeDasharray: '100%',
	    ...
	    return [trailFade.tween, oStagger.tween, oLine1Stagger.tween, burst.tween, oLine2Stagger.tween, mp.tween, trail.tween, trailFade.tween];
	  };
	...
	FirstBall = (function() {
	  ...
	  FirstBall.prototype.create = function() {
	    ...
	    burst = new mojs.Burst({
	      ...
	      stroke: this.o.CYAN,
	      strokeWidth: this.o.STROKE_WIDTH,
	      delay: (this.o.BALL_4_START + this.o.BALL_4_ARCDUR) * this.S,
	      isRunLess: this.o.IS_RUNLESS,
	      childOptions: {
	        radius: {
	          7: 0
...
/***/ function(module, exports, __webpack_require__) {
	...
	FirstBall = (function() {
	  ...
	  FirstBall.prototype.create = function() {
	    ...
	    return [t1Stagger.tween, t2Stagger.tween, t3Stagger.tween, burst.tween, mp.tween, trail.tween, trailFade.tween];
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	FirstBall = (function() {
	  ...
	  FirstBall.prototype.create = function() {
	    var burst, mDelay, mDuration, mp, n1Stagger, n2Stagger, opacityDelta, shift, trail, trailFade;
	    trail = new mojs.Transit({
	      bit: this.pathMask,
	      fill: 'transparent',
	      strokeDasharray: '100%',
	    ...
	    return [burst.tween, n1Stagger.tween, n2Stagger.tween, mp.tween, trail.tween, trailFade.tween];
	  };
